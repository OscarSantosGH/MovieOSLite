...
enum SearchCategories{
    static let allCategories:[MovieCategorySearch] = [
        ...
        MovieCategorySearch(title: "Fantasy", color1: .rgb(red: 89, green: 193, blue: 115), color2: .rgb(red: 161, green: 127, blue: 224), image: UIImage(named: "fantasy")!, url: "&with_genres=14"),
